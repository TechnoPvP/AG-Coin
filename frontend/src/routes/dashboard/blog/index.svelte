<script lang="ts">
	...
	import type { Blog, Difficulty, Status } from 'shared/blog';
	import type { Layout } from '$lib/types/types';
	import DifficultyBadge from '$lib/dashboard/blog/DifficultyBadge.svelte';
	...
	<div class="options">
		...
		<div class="filters">
			...
			<div class="difficulty">
				<DifficultyBadge selected={true} selectable difficulty="easy" />
				<DifficultyBadge selected={true} selectable difficulty="medium" />
				<DifficultyBadge selected={true} selectable difficulty="hard" />
			</div>
		</div>
